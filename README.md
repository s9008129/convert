...
> 詳細的逐版變更紀錄請見 [CHANGELOG.md](CHANGELOG.md)；正式環境的更新部署步驟請見 [部署更新手冊_v4.1.md](部署更新手冊_v4.1.md)。
...
> ⚠️ Docker 部署者：System Prompt 內嵌於容器，需重新套用映像後生效，步驟見 [部署更新手冊_v4.1.md](部署更新手冊_v4.1.md)。
