...
**版本**: v3.4.4 ✅ 繁體中文輸出修復 + Whisper 模型快取優化  
**更新日期**: 2025年1月  
**適用環境**: Windows 11/10 + RTX 4090 + Docker Desktop

> ⚠️ **重要**：開發前請先閱讀 [`INSTRUCTIONS.md`](../INSTRUCTIONS.md) - 最高指導原則
...
| `LOCAL_LLM_MODEL` | gemma4:31b | 使用的 LLM 模型 | ❌ 推薦保留 |
...
| 版本 | 日期 | 變更 |
|------|------|------|
| v3.4.4 | 2025-01 | 繁體中文輸出修復、Whisper 模型快取優化、新增 INSTRUCTIONS.md |
| v3.3.3 | 2025-01 | Windows 批次檔支援 |
